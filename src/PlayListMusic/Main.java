...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("===================================================");
		System.out.println("As musicas adicionadas foram: ");
		...
		System.out.println("===================================================");		
		System.out.println("Duracao da playlist com as musicas: " + playlist1.toString());
		...
		//LABEL PARA AUXILIAR NO QUE ESTA SENDO PRINTADO NA TELA
		System.out.println("===================================================");		
		System.out.print("Duracao da playlist com as musicas e os videos, lembrando que os vídeos podem conter ou nao propaganadas: ");
